              ...
              <div className="col-md-6">
                <div className="section-sub-title">
                  <article className="section-title-body">
                    <h1 className="head-title">We would love to connect...</h1>
                  </article>
                </div>
                <div className="widget-block dark">
                  <h4 className="widget-title">
                    <i className="ion-pound"></i>Node Nexus Network
                  </h4>
                  <h4 className="widget-title">
                    <i className="ion-map"></i>Hong Kong 888777
                  </h4>
                  <br />
                  <FacebookShareButton
                    url="https://youtu.be/6bytsvX6gAM"
                    quote="test"
                    hashtag="#react"
                  >
                  ...
                  &nbsp;
                  <PinterestShareButton
                    url="https://www.pinterest.com/pin/665406913672282630/"
                    media="https://assets.pinterest.com/ext/embed.html?id=665406913672282630"
                  >
