            ...
            <nav className="navbar navbar-default  navbar-expand-md">
                ...
                <div className={navToggle?'collapse navbar-collapse':'collapse navbar-collapse show'}  id="bs-example-navbar-collapse-1">
                    <ul className="nav navbar-nav  navbar-right menu-item-5" id="navbar-full">
                        ...
                        <li className="service"><span className="bg-icon">3</span><span className="rotated-title effect">Developer</span><Link to='services' className="link-item" smooth={false} duration={800} activeClass="active">Service</Link></li>
                        <li className="work"><span className="bg-icon">4</span><span className="rotated-title effect">Microservices</span><Link to='portfolio' className="link-item" smooth={false} duration={800} activeClass="active">Works</Link></li>
