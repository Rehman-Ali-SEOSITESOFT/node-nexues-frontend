                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-3 col-md-6">
                            <article className="footer-info-block">
                                ...
                                <p>Evolve today from a Node mindset to a partnership in a global infrastructure!</p>
                            </article>
                        </div>
                        <div className="col-xl-3 col-md-6">
                            <article className="footer-info-block">
                                ...
                                <ul className="list-unstyled">
                                    <li><a href="/">What is a Coaltion?</a></li>
                                    <li><a href="/">Are you an Application Developer?</a></li>
                                    <li><a href="/">Want to be a user on NNN?</a></li>
                                    <li><a href="/">Asset Backed Infrastructure?</a></li>
                                    <li><a href="/">Authentic Intelligence</a></li>
                                </ul>
                            </article>
