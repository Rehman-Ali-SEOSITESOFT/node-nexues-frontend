                ...
                <div className="row">
                    ...
                    <div className="col-xl-3 col-md-6">
                        <article className="footer-info-block">
                            ...
                            <ul className="list-unstyled">
                                <li><a href="/">A Node or Infrastructure?</a></li>
                    ...
                    <div className="col-xl-3 col-md-6">
                        <article className="footer-info-block">
                            ...
                            <ul className="list-unstyled">
                                <li><a href="/">NNN Introduction</a></li>
                                <li><a href="/">More about NNN</a></li>
                                <li><a href="/">Web 5.0?</a></li>
                                <li><a href="/">What is a Bond?</a></li>
                            </ul>
                        </article>
                    </div>
                </div>
