...
function AuthenticIntelligence() {
    return (
        <>
        <section  id="authentic-intelligence" className="bg-non-fixed">
                            ...
                            <div className="section-block-title">
                                <div className="section-title">   
                                    <article className="section-title-body mobile-mb-0">
                                        <h1 className="head-title wow fadeInDown animated" data-wow-duration="1.5s">Authentic Intelligence</h1>
...
export default AuthenticIntelligence
